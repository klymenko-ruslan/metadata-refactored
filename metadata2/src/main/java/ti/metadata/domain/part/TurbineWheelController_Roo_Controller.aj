...
import ti.metadata.domain.part.TurbineWheelController;
...
privileged aspect TurbineWheelController_Roo_Controller {
    ...
    public String TurbineWheelController.create(@Valid TurbineWheel turbineWheel, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/turbinewheels/" + encodeUrlPathSegment(turbineWheel.getPartId().toString(), httpServletRequest);
    }
    ...
    public String TurbineWheelController.show(@PathVariable("partId") Long partId, Model uiModel) {
        uiModel.addAttribute("turbinewheel", TurbineWheel.findTurbineWheel(partId));
    ...
    public String TurbineWheelController.updateForm(@PathVariable("partId") Long partId, Model uiModel) {
        populateEditForm(uiModel, TurbineWheel.findTurbineWheel(partId));
        return "turbinewheels/update";
    }
    
    @RequestMapping(value = "/{partId}", method = RequestMethod.DELETE, produces = "text/html")
    public String TurbineWheelController.delete(@PathVariable("partId") Long partId, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        TurbineWheel turbineWheel = TurbineWheel.findTurbineWheel(partId);
        turbineWheel.remove();
        uiModel.asMap().clear();
