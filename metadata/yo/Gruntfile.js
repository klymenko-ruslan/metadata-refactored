        ...
        options: {
          ...
          middleware: function (connect, options) {
            ...
            var middlewares = [
              ...
              connect().use('/application/carmodelengineyear/list', indexHtml),
              connect().use('/application/carmodelengineyear/form', indexHtml),
              connect().use('/application/carmake/list', indexHtml),
              connect().use('/application/carmake/form', indexHtml),
              connect().use('/application/carmodel/list', indexHtml),
              connect().use('/application/carmodel/form', indexHtml),
              connect().use('/application/carengine/list', indexHtml),
              connect().use('/application/carengine/form', indexHtml),
              connect().use('/application/carfueltype/list', indexHtml),
              connect().use('/application/carfueltype/form', indexHtml),
