...
public class InvoicesChunk {
    ...
    public static class Invoice {
        ...
        public Invoice(String no, String headerSeqNo, Long date, Long updated, String customerNo,
    ...
    public InvoicesChunk() {
    }

    public InvoicesChunk(List<Invoice> invoices, Long nextDate) {
