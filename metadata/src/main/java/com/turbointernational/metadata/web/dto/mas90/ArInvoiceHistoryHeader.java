...
public class ArInvoiceHistoryHeader {
    ...
    public ArInvoiceHistoryHeader(String iNVOICENO, String hEADERSEQNO, String mODULECODE, String iNVOICETYPE,
            Date iNVOICEDATE, Date tRANSACTIONDATE, String aRDIVISIONNO, String cUSTOMERNO, String tERMSCODE,
            String tAXSCHEDULE, String tAXEXEMPTNO, String sALESPERSONDIVISIONNO, String sALESPERSONNO,
            String cUSTOMERPONO, String aPPLYTOINVOICENO, String cOMMENT, String rEPETITIVEINVOICEREFNO, String jOBNO,
            ...
            String oRDERDATE, String bILLTONAME, String bILLTOADDRESS1, String bILLTOADDRESS2, String bILLTOADDRESS3,
            String bILLTOCITY, String bILLTOSTATE, String bILLTOZIPCODE, String bILLTOCOUNTRYCODE, String sHIPTOCODE,
            String sHIPTONAME, String sHIPTOADDRESS1, String sHIPTOADDRESS2, String sHIPTOADDRESS3, String sHIPTOCITY,
            String sHIPTOSTATE, String sHIPTOZIPCODE, String sHIPTOCOUNTRYCODE, Date sHIPDATE, String sHIPVIA,
            String sHIPZONE, String fOB, String cONFIRMTO, String cHECKNOFORDEPOSIT, String sPLITCOMMISSIONS,
            String sALESPERSONDIVISIONNO2, String sALESPERSONNO2, String sALESPERSONDIVISIONNO3, String sALESPERSONNO3,
            String sALESPERSONDIVISIONNO4, String sALESPERSONNO4, String sALESPERSONDIVISIONNO5, String sALESPERSONNO5,
            String pAYMENTTYPE, String pAYMENTTYPECATEGORY, String oTHERPAYMENTTYPEREFNO, String rMANO,
            String eBMSUBMISSIONTYPE, String eBMUSERIDSUBMITTINGTHISORDER, String eBMUSERTYPE, String sHIPPERID,
            String uSERKEY, String wAREHOUSECODE, String sHIPWEIGHT, String rESIDENTIALADDRESS, String eMAILADDRESS,
            String cRMUSERID, String cRMCOMPANYID, String cRMPERSONID, String cRMOPPORTUNITYID, Double tAXABLESALESAMT,
            Double nONTAXABLESALESAMT, Double fREIGHTAMT, Double sALESTAXAMT, Double cOSTOFSALESAMT,
            Double aMOUNTSUBJECTTODISCOUNT, Double dISCOUNTRATE, Double dISCOUNTAMT, Double sALESSUBJECTTOCOMM,
            Double cOSTSUBJECTTOCOMM, Double cOMMISSIONRATE, Double cOMMISSIONAMT, Double sPLITCOMMRATE2,
            Double sPLITCOMMRATE3, Double sPLITCOMMRATE4, Double sPLITCOMMRATE5, Double dEPOSITAMT, Double wEIGHT,
            Double rETENTIONAMT, Double nUMBEROFPACKAGES, Date dATEUPDATED, String tIMEUPDATED, String uSERUPDATEDKEY,
            String aRMC_234_ENTRYCURRENCY, Double aRMC_234_ENTRYRATE, Double aRMC_234_BASECOSTOFSALESAMT,
            Double aRMC_234_BASECOSTSUBJECTTOCOMM, Double aRMC_234_BASECOMMISSIONAMT, String bILLTODIVISIONNO,
