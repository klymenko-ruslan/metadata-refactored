...
public class GroupDaoTest extends AbstractFunctionalTest {
    ...
    public void testFilter() {
        Page<Tuple> page = groupDao.filter(1L /*null*/, Optional.empty(), Optional.of("re")/*Optional.empty()*/, /*Optional.of(Boolean.FALSE)*/ /*Optional.of(Boolean.TRUE)*/ Optional.empty(),
