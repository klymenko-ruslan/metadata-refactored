...
import com.turbointernational.metadata.entity.SalesNoteSearchResponse;
 ...
 * @author jrodriguez
 */
@Ignore // The test is not actual after migration to ArangoDb
...
public class SalesNoteRepositoryImplTest {
    ...
    public void setUp() {
        ...
        try {
            ...
            if (testPart != null) {
                // Line below is commented out because we can't emulate this
                // after migration to ArangoDb.
