...
public class PricingTest {
    ...
    public void setUp() throws SQLException {
        ...
        // Setup the default case: Price override with no additional bulk
        // discount
    ...
    public void testApplyPriceBreak_Percentage() throws SQLException {
        ...
        assertEquals(new BigDecimal("150.00"), instance.getPriceBreak(0).apply(new BigDecimal("200"))); // $200
                                                                                                        // @
                                                                                                        // 25%
                                                                                                        // discount
    }
    ...
    public void testCalculate_OneBreak() {
        instance = new Pricing(DiscountType.Override,
                new BigDecimal[] { new BigDecimal("999999"), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO,
                        BigDecimal.ZERO },
                new BigDecimal[] { new BigDecimal("10"), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO,
                        BigDecimal.ZERO });
    ...
    public void testCalculate_AllBreaks() {
        instance = new Pricing(DiscountType.Override,
                new BigDecimal[] { new BigDecimal("100"), new BigDecimal("200"), new BigDecimal("300"),
                        new BigDecimal("400"), new BigDecimal("500") },
                new BigDecimal[] { new BigDecimal("5000"), new BigDecimal("4000"), new BigDecimal("3000"),
