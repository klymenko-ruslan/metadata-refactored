...
insert into changelog_source_link(id, created, create_user_id) values (1, now(), 1);
insert into changelog(id, change_date, user_id, description) values(1, now(), 1, 'test');
insert into changelog_source(changelog_id, source_id, lnk_id) values(1, 1, 1);
