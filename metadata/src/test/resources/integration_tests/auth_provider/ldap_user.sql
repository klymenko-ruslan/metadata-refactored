...
insert into auth_provider_ldap(id, name, host, port) values(10, 'TurboInternational AD', 'ldap.turbointernational.com', 389);

insert into user(id, name, email, password, password_reset_token, enabled, auth_provider_id)
values(16, 'LDAP', 'dmytro.trunykov@zorallabs.com', '$2a$10$VTOODpmq0M1I5olJ.ih5IeZ7AKiNSOOSSMIcJIgmujZ5q5nXt0dSa', null, 1, 10);
