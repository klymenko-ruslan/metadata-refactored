...
.controller("indexCtrl", ["$scope", "$log", "$uibModal", "mockData",
    function($scope, $log, $uibModal, mockData) {
      ...
      $scope.actors = [
        {id: 1, name: "Vivian Ance", count: 21},
        {id: 2, name: "Jannifer Lawrence", count: 1},
        {id: 3, name: "Dakota Johnson", count: 4},
        {id: 4, name: "Esther Williams", count: 92},
        {id: 5, name: "Taraji Henson", count: 7}
      ];
